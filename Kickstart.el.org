...
#+begin_src emacs-lisp
    ...
    (cond ((eq system-type 'windows-nt)
           (setq exec-path (append exec-path '("C:/Program Files/Elixir/bin" "~/.zvm/bin")))))
...
#+begin_src emacs-lisp
  ...
  (if (eq system-type 'windows-nt)
      (setq zig-exe-path (concat (getenv "userprofile") "\\.zvm\\bin\\zig.exe"))
    (setq zig-exe-path "~/.zvm/bin/zig"))
